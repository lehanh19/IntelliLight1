...
def get_vehicle_id_entering():
    # Đếm số lượng xe đi vào ngã 4. Khi xe gần đến ngã 4 thì bắt đầu đếm 
    vehicle_id_entering = []
    entering_lanes = ['edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2',
                'edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2', 'edge1-0_2']
